...
# tf의 현재버전 함수를 호출할 경우 오류체크를 끄는 법(pycharm에서는 해당 오류가 발생하지 않음)
...
def plot_image(data, classes, width=28, height=28, row_len=3):
    for i in range(10):
        idxs = (classes == i)           #./deeplearning/autoencoders = data[idxs][0:10]
        autoencoders = data[idxs][0:10] # print(idxs, end=" : "); print(autoencoders)
